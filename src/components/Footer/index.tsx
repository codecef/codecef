...
const Footer = () => {
  return (
    <>
      ...
      <div className="w-full bg-gradient-to-r from-gray-800 to-gray-900 border-t border-blue-500/30">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                ...
                className="rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 text-base font-semibold text-white transition-all hover:from-blue-500 hover:to-purple-500"
              >
                📅 Book Free Demo
              </Link>
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-lg bg-[#25D366] px-6 py-3 text-base font-semibold text-white transition-all hover:bg-[#128C7E] hover:shadow-lg"
              >
                💬 WhatsApp Us
              </Link>
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-lg border-2 border-blue-500 px-6 py-3 text-base font-semibold text-blue-400 transition-all hover:bg-blue-500 hover:text-white"
              >
                🔗 Connect on LinkedIn
              </Link>
            </div>
      ...
      <footer className="relative z-10 bg-gray-900 border-t border-gray-800">
        <div className="container py-20 md:py-16 sm:py-12">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-3">
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-9 w-9 items-center justify-center rounded border border-gray-700 text-gray-400 transition-all duration-200 hover:border-blue-500 hover:text-blue-500"
                >
            ...
            <div>
              <h3 className="mb-6 text-xs font-bold uppercase tracking-wider text-blue-400">
                Quick Links
              </h3>
            ...
            <div>
              ...
              <div className="rounded-lg border border-green-500/30 bg-green-500/5 p-3 backdrop-blur-sm">
