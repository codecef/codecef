...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 pb-16 pt-[120px] md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <div className={`max-w-[600px] transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h1 className="mb-6 text-3xl font-bold leading-tight text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight lg:text-4xl lg:leading-tight">
                  Transform Ideas into <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Powerful Digital Products.</span>
                </h1>
                <p className="mb-10 text-base !leading-relaxed text-gray-400 sm:text-lg md:text-xl lg:text-lg">
                ...
                <div className="flex flex-col items-center gap-3 sm:flex-row sm:gap-4 sm:items-stretch">
                  <Link
                    ...
                    className="rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 text-base font-bold text-white duration-300 ease-in-out hover:from-blue-500 hover:to-purple-500 hover:shadow-lg transform hover:scale-105 transition-all lg:text-sm"
                  >
                    Book Free Demo
                  </Link>
                  <Link
                ...
                <p className="mt-4 text-center text-sm text-gray-400 sm:text-left lg:text-xs">
                ...
                <div className="mt-6 flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:justify-start">
                  <div className="flex items-center text-sm text-gray-400 lg:text-xs">
            ...
            <div className="w-full px-4 lg:w-1/2 hidden md:block">
              <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="relative mx-auto max-w-[400px] rounded-2xl bg-gray-800/80 backdrop-blur-sm p-6 shadow-2xl lg:max-w-[450px] border border-gray-700">
                  <div className="mb-4 flex items-center">
                    <div className="relative">
                      <div className="h-3 w-3 rounded-full bg-green-500"></div>
                      <div className="absolute h-3 w-3 animate-ping rounded-full bg-green-400"></div>
                    </div>
                    <span className="ml-3 text-sm font-medium text-gray-300 lg:text-xs">
                      🟢 CodeCEF &mdash; Available Now
                    </span>
                  </div>
                  
                  <div className="mb-4">
                    <p className="text-sm font-medium text-gray-300 mb-4 lg:text-xs">
                    ...
                    <div className="space-y-3">
                      <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block w-full rounded-lg bg-blue-500/10 border border-blue-500/20 p-4 hover:bg-blue-500/20 hover:border-blue-500/40 transition-all duration-300 group"
                      >
                        <div className="flex items-center">
                          <div className="mr-3 flex h-10 w-10 items-center justify-center rounded-lg bg-blue-500/20 text-blue-400 group-hover:bg-blue-500 group-hover:text-white">
                            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                          </div>
                          <div className="text-left">
                            <p className="text-sm font-semibold text-white lg:text-xs">📅 Book Free Google Meet</p>
                            <p className="text-xs text-gray-400">30 min · Free · Video call</p>
                          </div>
                        </div>
                      </Link>
                      ...
                      <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block w-full rounded-lg bg-green-500/10 border border-green-500/20 p-4 hover:bg-green-500/20 hover:border-green-500/40 transition-all duration-300 group"
                      >
                        <div className="flex items-center">
                          <div className="mr-3 flex h-10 w-10 items-center justify-center rounded-lg bg-green-500/20 text-green-400 group-hover:bg-green-500 group-hover:text-white">
                          ...
                          <div className="text-left">
                            <p className="text-sm font-semibold text-white lg:text-xs">💬 Chat on WhatsApp</p>
                            <p className="text-xs text-gray-400">Instant reply · Text/Voice</p>
                          </div>
                        </div>
                      </Link>
                    </div>
